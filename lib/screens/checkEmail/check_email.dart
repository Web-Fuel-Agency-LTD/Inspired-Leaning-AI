...
import 'package:inspired_learning_ai/screens/NewPassword/new_password.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton(
                ...
                child: const Text(
                  'Resend Code',
                  style: TextStyle(color: ILColors.secondary, fontSize: 18, fontWeight: FontWeight.w600),
                ),
              ),
              const SizedBox(height: 40),
              ILElevatedButton(
                width: double.infinity,
                onPressed: () {Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => NewPassword()));},
                text: 'Verify'),
            ],
          ),
        ),

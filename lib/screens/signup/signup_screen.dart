              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Let\'s get Started!', style: TextStyle(fontSize: 38, color: Colors.white, fontWeight: FontWeight.w400)),
                    const SizedBox(
                      height: 50,
                    ),
                    SignupButton(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          ...
                          child: const Text('Log In', style: TextStyle(color: ILColors.secondary, fontSize: 18, fontWeight: FontWeight.bold))),
                      ],
                    )
